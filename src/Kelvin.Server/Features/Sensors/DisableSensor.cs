...
public class DisableSensorHandler(KelvinContext context, IMemoryCache cache, IHubContext<ControlHub, IControlClient> controlHub)
  : IHandler<DisableSensorRequest>
{
